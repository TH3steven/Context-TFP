...
public class CameraSettings {
    private static final int PAN_LIMIT_LOW = 0;
    private static final int PAN_LIMIT_HIGH = 65536;
    
    private static final int TILT_LIMIT_LOW = 0;
    private static final int TILT_LIMIT_HIGH = 65536;
    
    private static final int ZOOM_LIMIT_LOW = 0;
    private static final int ZOOM_LIMIT_HIGH = 100;
    ...
    public void pan(int offset) {
        pan = (pan + offset > PAN_LIMIT_LOW 
            && pan + offset < PAN_LIMIT_HIGH) ? pan + offset : pan;
    }
    ...
    public void tilt(int offset) {
        tilt = (tilt + offset > TILT_LIMIT_LOW 
            && tilt + offset < TILT_LIMIT_HIGH) ? tilt + offset : tilt;
    }
    ...
    public void zoom(int offset) {
        zoom = (zoom + offset > ZOOM_LIMIT_LOW 
            && zoom + offset < ZOOM_LIMIT_HIGH) ? zoom + offset : zoom;
    }
}
